...
void protobuf_AssignDesc_dedupv1_5fstats_2eproto() {
  ...
  static const int ChunkIndexFilterStatsData_offsets_[6] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ChunkIndexFilterStatsData, empty_fp_hit_count_),
  };
  ...
  GarbageCollectorStatsData_descriptor_ = file->message_type(10);
  ...
  RabinChunkerStatsData_descriptor_ = file->message_type(11);
  ...
  ContentStorageStatsData_descriptor_ = file->message_type(12);
  ...
  LogStatsData_descriptor_ = file->message_type(13);
...
const int ChunkIndexFilterStatsData::kEmptyFpHitCountFieldNumber;
#endif  // !_MSC_VER
...
void ChunkIndexFilterStatsData::SharedCtor() {
  ...
  empty_fp_hit_count_ = GOOGLE_ULONGLONG(0);
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_empty_fp_hit_count;
        break;
      }

      // optional uint64 empty_fp_hit_count = 5;
      case 5: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_empty_fp_hit_count:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::uint64, ::google::protobuf::internal::WireFormatLite::TYPE_UINT64>(
                 input, &empty_fp_hit_count_)));
          set_has_empty_fp_hit_count();
        } else {
          goto handle_uninterpreted;
        }
...
void ChunkIndexFilterStatsData::SerializeWithCachedSizes(
  ...
  // optional uint64 empty_fp_hit_count = 5;
  if (has_empty_fp_hit_count()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(5, this->empty_fp_hit_count(), output);
  }
...
::google::protobuf::uint8* ChunkIndexFilterStatsData::SerializeWithCachedSizesToArray(
  ...
  // optional uint64 empty_fp_hit_count = 5;
  if (has_empty_fp_hit_count()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt64ToArray(5, this->empty_fp_hit_count(), target);
  }
...
void ChunkIndexFilterStatsData::MergeFrom(const ChunkIndexFilterStatsData& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_empty_fp_hit_count()) {
      set_empty_fp_hit_count(from.empty_fp_hit_count());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void ChunkIndexFilterStatsData::Swap(ChunkIndexFilterStatsData* other) {
  if (other != this) {
    ...
    std::swap(empty_fp_hit_count_, other->empty_fp_hit_count_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
