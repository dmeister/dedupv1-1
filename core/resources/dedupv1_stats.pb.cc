...
void protobuf_AddDesc_dedupv1_5fstats_2eproto() {
    ...
    ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
        ...
        "anchor_count\030\007 \001(\004\"b\n\030ZeroChunkFilterSta"
        "tsData\022\032\n\022existing_hit_count\030\001 \001(\004\022\026\n\016we"
        "ak_hit_count\030\002 \001(\004\022\022\n\nread_count\030\003 \001(\004\"\303"
        "\001\n\031GarbageCollectorStatsData\022\035\n\025processe"
        "d_block_count\030\001 \001(\004\022$\n\034processed_gc_cand"
        "idate_count\030\002 \001(\004\022\033\n\023skipped_chunk_count"
        "\030\003 \001(\004\022%\n\035already_processed_chunk_count\030"
        "\004 \001(\004\022\035\n\025processed_chunk_count\030\005 \001(\004\"o\n\025"
        "RabinChunkerStatsData\022\023\n\013chunk_count\030\001 \001"
        "(\004\022\037\n\027size_forced_chunk_count\030\002 \001(\004\022 \n\030c"
        "lose_forced_chunk_count\030\003 \001(\004\"i\n\027Content"
        "StorageStatsData\022\022\n\nread_count\030\001 \001(\004\022\023\n\013"
        "write_count\030\002 \001(\004\022\021\n\tread_size\030\003 \001(\004\022\022\n\n"
        "write_size\030\004 \001(\004\"\245\001\n\014LogStatsData\022\023\n\013eve"
        "nt_count\030\001 \001(\004\022\034\n\024replayed_event_count\030\002"
        " \001(\004\0223\n\rlogtype_count\030\003 \003(\0132\034.LogStatsDa"
        "ta.LogTypeCounter\032-\n\016LogTypeCounter\022\014\n\004t"
        "ype\030\001 \001(\005\022\r\n\005count\030\002 \001(\004", 2144);
    ...
    while ((tag = input->ReadTag()) != 0) {
        ...
        case 1: {
            ...
            if (input->ExpectTag(16)) {
                goto parse_index_full_failure_count;
            }
            break;
        }
...
parse_index_write_count:
            ...
            if (input->ExpectTag(24)) {
                goto parse_index_real_write_count;
            }
            break;
        }
...
parse_index_real_write_count:
            ...
            if (input->ExpectTag(32)) {
                goto parse_imported_block_count;
            }
            break;
        }
...
parse_imported_block_count:
            ...
            if (input->ExpectTag(40)) {
                goto parse_failed_block_write_count;
            }
            break;
        }
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
    ...
    while ((tag = input->ReadTag()) != 0) {
        ...
        case 1: {
            ...
            if (input->ExpectTag(16)) {
                goto parse_write_cache_hit_count;
            }
            break;
        }
...
parse_write_cache_hit_count:
            ...
            if (input->ExpectTag(24)) {
                goto parse_container_timeout_count;
            }
            break;
        }
...
parse_container_timeout_count:
            ...
            if (input->ExpectTag(32)) {
                goto parse_readed_container_count;
            }
            break;
        }
...
parse_readed_container_count:
            ...
            if (input->ExpectTag(40)) {
                goto parse_committed_container_count;
            }
            break;
        }
...
parse_committed_container_count:
            ...
            if (input->ExpectTag(48)) {
                goto parse_moved_container_count;
            }
            break;
        }
...
parse_moved_container_count:
            ...
            if (input->ExpectTag(56)) {
                goto parse_merged_container_count;
            }
            break;
        }
...
parse_merged_container_count:
            ...
            if (input->ExpectTag(64)) {
                goto parse_failed_container_count;
            }
            break;
        }
...
parse_failed_container_count:
            ...
            if (input->ExpectTag(72)) {
                goto parse_deleted_container_count;
            }
            break;
        }
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
    ...
    while ((tag = input->ReadTag()) != 0) {
        ...
        case 1: {
            ...
            if (input->ExpectTag(16)) {
                goto parse_processed_gc_candidate_count;
            }
            break;
        }
...
parse_processed_gc_candidate_count:
            ...
            if (input->ExpectTag(24)) {
                goto parse_skipped_chunk_count;
            }
            break;
        }
...
parse_skipped_chunk_count:
            ...
            if (input->ExpectTag(32)) {
                goto parse_already_processed_chunk_count;
            }
            break;
        }
...
parse_already_processed_chunk_count:
            ...
            if (input->ExpectTag(40)) {
                goto parse_processed_chunk_count;
            }
            break;
        }
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
    ...
    while ((tag = input->ReadTag()) != 0) {
        ...
        case 1: {
            ...
            if (input->ExpectTag(16)) {
                goto parse_size_forced_chunk_count;
            }
            break;
        }
...
parse_size_forced_chunk_count:
            ...
            if (input->ExpectTag(24)) {
                goto parse_close_forced_chunk_count;
            }
            break;
        }
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
    ...
    while ((tag = input->ReadTag()) != 0) {
        ...
        case 1: {
            ...
            if (input->ExpectTag(16)) {
                goto parse_replayed_event_count;
            }
            break;
        }
