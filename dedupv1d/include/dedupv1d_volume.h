...
class Dedupv1dVolume: public dedupv1::StatisticProvider {
    ...
    private:
         ...
         * A preconfigured volume cannot be modified during runtime, especially it cannot be deleted.
         * Preconfigured volume should rarely be used in production, but they are useful for development and testing.
         *
         */
        bool preconfigured_;
    ...
    public:
         ...
         * @return
         */
        dedupv1::scsi::ScsiResult MakeRequest(dedupv1::request_type type, uint64_t offset, uint64_t size, byte* buffer,
